...
public class BillAdapter extends RecyclerView.Adapter<BillAdapter.BillViewHolder> {
    ...
    public BillAdapter(LayoutInflater layoutInflater, ArrayList<Order> list) {
        this.mList = list;
        mLI = layoutInflater;
    ...
    public static class BillViewHolder extends RecyclerView.ViewHolder {
        ...
        public BillViewHolder(@NonNull View itemView) {
            super(itemView);
            TextNumber = itemView.findViewById(R.id.textView_number);
            TextTime = itemView.findViewById(R.id.textView_time);
            TextTakeAway = itemView.findViewById(R.id.textView_takeAway);
            TextCost = itemView.findViewById(R.id.textView_cost);
        }
